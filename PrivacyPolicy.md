# Privacy Policy for GAuth


Thank you for downloading GAuthentification (Gath). GAuth. was developed by, and is owned and operated by, VA.
...
For purposes of the Policy, “Application” refers to GAuth. as the case may be. Application also includes any Application updates and upgrades that VA may provide to you or make available to you, or that you obtain after the date you obtain your initial copy of the Application, to the extent that such items are not accompanied by a separate Privacy Policy.
...
The following is a complete listing and description of what functions on the Device are accessed and / or modified by the Application. Unless otherwise indicated, the permission applies GAuth.:
